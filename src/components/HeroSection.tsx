  ...
  return (
    <div className="relative h-screen w-full overflow-hidden flex flex-col items-center justify-center text-center px-4">
      ...
      <div className="absolute inset-0 opacity-10 z-0">
        <div className="absolute top-[10%] left-[15%] text-green-500 text-6xl opacity-30">
          ₿
        </div>
        <div className="absolute top-[20%] right-[20%] text-green-500 text-6xl opacity-30">
          Ξ
        </div>
        <div className="absolute bottom-[25%] left-[25%] text-green-500 text-6xl opacity-30">
          ⟠
        </div>
        <div className="absolute bottom-[15%] right-[15%] text-green-500 text-5xl opacity-30">
          ₮
        </div>
        <div className="absolute top-[50%] left-[50%] text-green-500 text-4xl opacity-30">
          ₱
        </div>
      </div>
